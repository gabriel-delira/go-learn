...
func Test(tpl *text.Template) {
	...
	restaurantA := entities.Restaurant{
		Name: "Restaurant A",
	...
	restaurantB := entities.Restaurant{
		Name: "Restaurant B",
		Breakfast: entities.Menu{
			Name: "Breakfast",
			Foods: []entities.Food{
	...
	restaurants := entities.Restaurants{Restaurants: []entities.Restaurant{restaurantA, restaurantB}}
